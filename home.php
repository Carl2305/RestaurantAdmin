...
<head>
  ...
  <title>Inicio - RestaurantlyAdmin</title>
...
<body>
  ...
  <main id="main" class="main">
      ...
      <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-success" id="btn-check-order">Marcar Como Enviado</button>
          </div>
        </div>
      </div>
    ...
    <form class="modal fade" id="formvalidatepassword" tabindex="-1" autocomplete="off" data-bs-backdrop="static" method="post" role="form">
